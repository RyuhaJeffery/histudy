...
class RegisterView extends GetView<RegisterController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('RegisterView',style: TextStyle(color:Colors.black54),),
        centerTitle: true,
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Container(
                                ...
                                child: Column(
                                  children: [
                                    ListTile(
                                      leading: Text("${index + 1}",style: TextStyle(fontSize: 14,fontWeight: FontWeight.bold),),
                                      title: Container(
                                        width: 20,
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text(documentSnapshot['class'],style: TextStyle(fontSize: 15),),
                                            Text(
                                                "과목코드: ${documentSnapshot['code']} / ${documentSnapshot['professor']} 교수님",style: TextStyle(fontSize: 15),),
