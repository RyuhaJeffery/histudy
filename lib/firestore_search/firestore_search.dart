...
import 'src/mvc/controllers/firestore_search_controller.dart';
import 'src/mvc/services/firestore_service.dart';
import 'src/mvc/widgets/search_field.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
export 'src/mvc/controllers/firestore_search_controller.dart'
    hide FirestoreSearchController;
export 'src/mvc/views/search_bar.dart' show FirestoreSearchBar;
export 'src/mvc/views/search_results.dart' show FirestoreSearchResults;
...
class FirestoreSearchScaffold extends StatefulWidget {
  ...
  final String? firestoreDocsName;
  final String? firestoreSubCollectionName;
  ...
  const FirestoreSearchScaffold({
    ...
    this.firestoreSubCollectionName,
    this.firestoreDocsName,
